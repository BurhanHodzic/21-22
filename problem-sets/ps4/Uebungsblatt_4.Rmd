...
cor(eu_makro$unempl,eu_makro$debt_share_country,use = "pairwise.complete.obs" )
...
dat <- filter(eu_makro, country %in% c("France", "Germany", "Netherlands"))
